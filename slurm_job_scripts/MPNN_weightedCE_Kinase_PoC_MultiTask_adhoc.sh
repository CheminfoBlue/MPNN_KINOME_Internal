...
#SBATCH --job-name=MPNN_weightedCE_Kinase_PoC_MultiTask_adhoc

#SBATCH --partition=gpu-t4-4x

#SBATCH --output=MPNN_weightedCE_Kinase_PoC_MultiTask_adhoc_out.log

#SBATCH --error=MPNN_weightedCE_Kinase_PoC_MultiTask_adhoc_error.log
