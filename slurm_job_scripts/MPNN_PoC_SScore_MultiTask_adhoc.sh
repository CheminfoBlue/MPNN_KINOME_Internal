...
#SBATCH --job-name=MPNN_PoC_SScore_MultiTask_adhoc

#SBATCH --partition=gpu-t4-4x

#SBATCH --output=MPNN_PoC_SScore_MultiTask_adhoc_out.log

#SBATCH --error=MPNN_PoC_SScore_MultiTask_adhoc_error.log
